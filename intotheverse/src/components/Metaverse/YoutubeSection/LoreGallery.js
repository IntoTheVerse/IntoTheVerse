...
const LoreGallery = () => {
    ...
    return (
        <section className="LoreGallery">
            <section className="LoreGallery__titleContainer">
                <p>
                    <span className="LoreGallery__titleContainer__highlightText">"</span>
                    Lore
                    <span className="LoreGallery__titleContainer__highlightText">"</span>
                </p>
            </section>
            <section className="LoreGallery__widgetContainer">
                <section className="LoreGallery__widgetContainer__Box">
